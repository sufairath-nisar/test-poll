...
import { openOrUpdatePollWindow } from '../utils/pollWindowManager'; // Adjust the import path as necessary
...
export function PollDisplay({ token, pollId }: PollDisplayProps) {
  ...
  // after your WS effect
// useEffect(() => {
//   if (poll) {
//     console.log('[Parent] sending to popup', poll);
//     openOrUpdatePollWindow(poll);
//   }
// }, [poll]);
